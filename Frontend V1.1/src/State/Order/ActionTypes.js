// Action types for creating/paying for an order
...
// Action types for fetching a specific order by ID
export const GET_ORDER_REQUEST = 'GET_ORDER_REQUEST';
export const GET_ORDER_SUCCESS = 'GET_ORDER_SUCCESS';
export const GET_ORDER_FAILURE = 'GET_ORDER_FAILURE';

// Action types for fetching all orders belonging to the user
